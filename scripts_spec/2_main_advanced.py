...
alpha_vec = [6] #[11,22] add 2,5,8 # [2,5,8,11,22,32,43,55]
#bal = 50
version = 6
...
for alpha in alpha_vec:
    ...
    data1 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2800.0_sg4.1.pkl')
    # Other datasets for CNN
    data2 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2500.0_sg4.1.pkl')
    #data3 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2800.0_sg4.1.pkl')
    #data4 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg4.1.pkl')
    data3 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp3100.0_sg4.1.pkl')
    data4 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2700.0_sg3.7.pkl')
    #data7 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg3.9.pkl')
    data5 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg4.3.pkl')
    ...
    ## IMPORT DATA  (can be loops or parallellized tasks etc)
    data1 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_test_sets/final_testset_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2800.0_sg4.1.pkl')
    # Other datasets for CNN
    data2 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_test_sets/final_testset_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2500.0_sg4.1.pkl')
    #data3 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2800.0_sg4.1.pkl')
    #data4 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg4.1.pkl')
    data3 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_test_sets/final_testset_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp3100.0_sg4.1.pkl')
    data4 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_test_sets/final_testset_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2700.0_sg3.7.pkl')
    #data7 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_sets/final_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg3.9.pkl')
    data5 = pd.read_pickle(data_path + 'csv_inputs/CCF_realistic_fakeplanets/final_test_sets/final_testset_H2O_crosscorr_data_alpha_' + str(alpha) + '_temp2900.0_sg4.3.pkl')
    ...
    for d in datas:
        ...
        data_test = datas_test[d].loc[(str(datas_test[d].index.levels[0][j]), slice(None)), :]
        ...
        X_test[d] = data_test.drop(['tempP', 'loggP', 'H2O', 'CO', 'CH4', 'NH3'], axis=1)
    ...
    results = {'results': res_opt_method, 'confusion matrix': CM_opt, 'hyperparameters': hyperparam_optim,
               'y_test': list(y_test)}
    a_file = open(results_path + "export_CV/from_GPU_byfold/results_realisticfakeplanets_data_"+str(x)+"_alpha_"+str(alpha)+"_CV_testfold" + str(j) + ".pkl", "wb")
    pickle.dump(results, a_file)
    a_file.close()

    # export optimizaiton results
    a_file = open(results_path + "export_CV/from_GPU_byfold/GA_results_realisticfakeplanets_data_"+str(x)+"_alpha_"+str(alpha)+"_CV_testfold" + str(j) + ".pkl", "wb")
