...
data_name='GQlupb'
template_characteristics = {'Temp': 1600, 'Surf_grav': 4.1, 'H2O': 1, 'CO': 0}
...
plt.legend()
plt.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/Aggregated_ROC.pdf')
plt.show() 
...
plt.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/Aggregated_PR.pdf')
plt.show() 
...
for m in methods:
    ...
    g.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/Histogram_PIT_'+m+'.pdf')

    it=it+1
        

dfscores.to_csv(csv_res_path+"csv_results/dfscores.csv") 
...
for m in methods:
    ...
    RT.to_csv(csv_res_path+"csv_results/RT_"+str(m)+".csv")

RTdf_GA.to_csv(csv_res_path+"csv_results/RT_GA.csv")   
RTdf_method.to_csv(csv_res_path+"csv_results/RT_method.csv")   
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_RF.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_LAS.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_RID.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_ENET.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_ENET2.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_PCT.pdf')
fg.show()
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_CNN1.pdf')
fg.show()
...
axes[ax01[1], ax02[1]].plot(np.arange(-2000,2000,1), ls_results[0]['results']['LAS']['weights']['parameters'], color=color_ls['LAS'])
axes[ax01[1], ax02[1]].label_outer()
axes[ax01[1], ax02[1]].set_title("Weights Lasso", fontsize=9)  

axes[ax01[2], ax02[2]].plot(np.arange(-2000,2000,1), ls_results[0]['results']['RID']['weights']['parameters'], color=color_ls['RID'])
axes[ax01[2], ax02[2]].label_outer()
axes[ax01[2], ax02[2]].set_title("Weights Ridge", fontsize=9)  

axes[ax01[3], ax02[3]].plot(np.arange(-2000,2000,1), ls_results[7]['results']['ENET2']['weights']['parameters'], color=color_ls['ENET'])
#axes[ax01[3], ax02[3]].label_outer()
axes[ax01[3], ax02[3]].set_title("Weights ElasticNet", fontsize=9)  

axes[ax01[4], ax02[4]].plot(np.arange(-2000,2000,1), ls_results[2]['results']['PCT']['weights'][0][:,1], color=color_ls['PCT'])
...
fg.tight_layout()
fg.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/weights_models.pdf')
fg.show()
...
plt.savefig('C:/Users/emily/Documents/ML_spectroscopy_thesis/90_sweave_template/distribution_signals.pdf')
plt.show()
